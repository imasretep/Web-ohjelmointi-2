...
const AddComment = () => {
  ...
  const addComment = () => {
    ...
    dispatch(createComment({ data })).then((data) => {
      console.log(data);
      if (data !== undefined) {
        setCommented(true);
      }
      ...
      {commented ? (
        ...
        <div>
          <div className="mb-3">
            ...
            <select onChange={onChangeTutorial}>
          ...
          <div className="form-group">
            ...
            <input type="text" className="form-control" id="comment" required value={comment} onChange={onChangeComment} name="comment" />
          </div>
